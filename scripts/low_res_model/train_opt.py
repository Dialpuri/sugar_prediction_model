    ...
    while True:
        for candidate in df_np:
            ...
            if atom_type == Types.base:
                ...
                base_array = get_atom_density(base_path)
                raw_density = get_density(density_path)
            ...
            if atom_type == Types.sugar:
                ...
                sugar_array = get_atom_density(sugar_path)
                raw_density = get_density(density_path)
            ...
            if atom_type == Types.phosphate:
                ...
                phosphate_array = get_atom_density(phosphate_path)
                raw_density = get_density(density_path)
