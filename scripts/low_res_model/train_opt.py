...
def sample_generator(dataset: str = "train"):
    ...
    def get_density(path: str, translation: List[int, int, int]) -> np.ndarray:
    ...
    def get_atom_density(path: str, translation: List[int, int, int]) -> np.ndarray: 
